        ...
        <section className="rounded-[1.6rem] border border-gold-border/12 bg-white/62 px-4 py-4 shadow-[0_14px_34px_-30px_rgba(0,0,0,0.35)] dark:border-dark-border/55 dark:bg-[#111]/40">
            <div className="mb-3 flex items-start justify-between gap-3 border-b border-gold-border/8 pb-3 dark:border-dark-border/35">
                <div className="min-w-0">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.32em] text-gold-primary/70 dark:text-gold-light/70">현재 재생</p>
                    <h3 className="mt-2 line-clamp-2 font-display text-lg text-text-primary dark:text-dark-text-primary">{track.title}</h3>
                    <p className="mt-1 text-sm text-text-secondary dark:text-dark-text-secondary">{album.title}</p>
                </div>
            </div>
